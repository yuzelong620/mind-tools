...
import com.globalgame.auto.wmsg.SysMessageCode;
import com.mind.core.net.msg.SWBaseMessage;
...
*自动生成类
*/
public class ${className?cap_first} extends SWBaseMessage{
<#if (fields?size > 0)>
...
<#elseif fields?size==0>
	...
	public short getMessageType() {
		return SysMessageCode.${className?cap_first}_CODE;
	}
